...
// function contaVocali(Stringa:string):number{

//     let count=0;
//     let vocal:string ="aeoiu";
//    let min:string= Stringa.toLowerCase();
//     for( let char of min){
...
// contaVocali("ciao buongiorno");


//crea una funzione che restituisce la stringa al contrario

function inverteString(stringa:string):string{
 
    let reverse:string ="";
    for(let i:number = (stringa.length-1); i>=0; i--){
